---
title: Data Fetching
description: Next.js cho phép bạn fetch dữ liệu theo nhiều cách, với pre-rendering, server-side rendering hoặc static-site generation, và incremental static regeneration. Tìm hiểu cách quản lý dữ liệu ứng dụng của bạn trong Next.js.
---

Data fetching trong Next.js cho phép bạn render nội dung của bạn theo nhiều cách khác nhau, tùy thuộc vào trường hợp sử dụng của ứng dụng của bạn. Chúng bao gồm pre-rendering với **Server-side Rendering** hoặc **Static Generation**, và cập nhật hoặc tạo nội dung tại runtime với **Incremental Static Regeneration**.
